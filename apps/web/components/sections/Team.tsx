...
export default function Team() {
  ...
  const getExpertiseColor = (expertise: string) => {
    switch (expertise) {
      case 'BCI': return 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30'
      case 'ML/AI': return 'bg-purple-500/20 text-purple-400 border-purple-500/30'
      case 'Data': return 'bg-blue-500/20 text-blue-400 border-blue-500/30'
      case 'Cloud': return 'bg-green-500/20 text-green-400 border-green-500/30'
      case 'IT Sys': return 'bg-orange-500/20 text-orange-400 border-orange-500/30'
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getExpertiseColor(member.expertise)}`}>
                    {member.expertise}
                  </span>
                </div>
