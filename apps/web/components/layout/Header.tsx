        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-4">
              ...
              <span className="hidden lg:block text-sm text-white/70" style={{ fontFamily: 'Neue Haas Grotesk Medium, -apple-system, BlinkMacSystemFont, sans-serif', fontWeight: 500 }}>
                Massachusetts Institute of Technology
              </span>
              <span className="lg:hidden text-xs text-white/70" style={{ fontFamily: 'Neue Haas Grotesk Medium, -apple-system, BlinkMacSystemFont, sans-serif', fontWeight: 500 }}>
                MIT
              </span>
            </div>
          </div>
          ...
          >
            <nav className="flex flex-col py-4">
              ...
              <div className="px-6 py-4 mt-2 border-t border-white/10 flex items-center gap-3">
                <svg className="h-6 w-auto" viewBox="0 0 536.229 536.229" fill="white" fillOpacity="0.6" xmlns="http://www.w3.org/2000/svg">
                  <g>
                    <g>
                      <rect y="130.031" width="58.206" height="276.168"/>
                      <rect x="95.356" y="130.031" width="58.206" height="190.712"/>
                ...
                <span className="text-xs text-white/60" style={{ fontFamily: 'Neue Haas Grotesk Medium, -apple-system, BlinkMacSystemFont, sans-serif', fontWeight: 500 }}>
                  Massachusetts Institute of Technology
                </span>
              </div>
            </nav>
