...
export default function Problem() {
  ...
  return (
    <section
      id="specificity"
      ref={containerRef}
      className="min-h-screen flex items-center px-4 sm:px-6 md:px-12 lg:px-24 py-12 md:py-20 lg:py-24 relative"
    >
      ...
      <motion.div style={{ opacity, y }} className="max-w-5xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl sm:text-2xl font-light mb-4 md:mb-6 text-white/90">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-light mb-3 text-blue-400">
                  Core Architecture: Modular Monolith Design
                </h4>
                <p className="text-white/60 text-sm leading-relaxed mb-4">
                  Built on our proprietary Modular Monolith Architecture, the system ensures stable,
                  scalable development with controlled dependencies. At its heart, the Neural
                  Management System (NMS) orchestrates all operations across specialized layers:
                </p>
                <div className="space-y-2 text-sm pl-4">
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-3">•</span>
                    <span className="text-white/70">
                      <strong>NIIL:</strong> Managing neural interfaces and mixed reality
                      environments
                    </span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-3">•</span>
                    <span className="text-white/70">
                      <strong>PICL:</strong> Controlling robotic systems and IoT devices
                    </span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-3">•</span>
                    <span className="text-white/70">
                      <strong>ADAM:</strong> Housing our advanced AI/ML models for real-time
                      processing
                    </span>
                  </div>
                </div>
              ...
              <div>
                <h4 className="text-lg font-light mb-3 text-blue-400">
                  Ultra-High-Speed Neural Data Processing
                </h4>
          ...
          >
            <div>
              <h4 className="text-lg font-light mb-4 text-white/90">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-3">
                Revolutionary passwordless Neural ID - authentication derived from your unique
                neural patterns, providing secure access to robotic prosthetics, virtual
                environments, and agentic applications.
              </p>
            </div>
