...
class BaseNeuralMCPServer(ABC):
    ...
    async def handle_request(self, client_id: str, request: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def authenticate_request(self, client_id: str, request: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        api_key = (
            request.get("params", {}).get("api_key") or
    ...
    async def check_permission(self, client_id: str, permission: str, resource: str = None) -> bool:
    ...
    async def handle_call_tool(self, client_id: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def handle_read_resource(self, client_id: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def register_tool(self, name: str, handler: Callable, description: str, 
                     input_schema: Dict[str, Any], permissions: List[str] = None):
    ...
    def register_resource(self, uri: str, name: str, mime_type: str, 
                         handler: Callable, permissions: List[str] = None):
