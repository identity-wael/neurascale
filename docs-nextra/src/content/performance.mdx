...
<Cards>
  <Card title="Profile First" icon="🔍">
    Always profile before optimizing. Use tools like cProfile, py-spy, and Chrome DevTools.
  </Card>
  <Card title="Cache Aggressively" icon="💾">
    Implement caching at multiple levels: CDN, API, database, and application.
  </Card>
  <Card title="Batch Operations" icon="📦">
    Process data in batches to reduce overhead and improve throughput.
  </Card>
  <Card title="Async Everything" icon="⚡">
