...
const DSMMatrix = () => {
  ...
  const components = [
    ...
    "Robotic Control Network Slice", "Graphics Processing Units",
    ...
    "Programming Languages", "C++ Programming Language", "Python Programming Language",
    "VHDL Programming Language", "Identity Management System", "Google Identity",
      ...
      {selectedNode && (
        <div className="absolute top-2 right-2 bg-gray-800 p-2 rounded text-xs max-w-48">
          ...
          <div className="text-gray-300">
            <div className="text-cyan-300">{selectedNode.from.split(' ').slice(0, 2).join(' ')}</div>
            <div className="text-center">↓</div>
            <div className="text-purple-300">{selectedNode.to.split(' ').slice(0, 2).join(' ')}</div>
          </div>
          <button
