...
<Callout type="warning">
  NeuraScale requires **Python 3.12.11** specifically. Other versions may cause issues.
</Callout>
...
<Callout type="info">
  If you have Python version issues, use the setup script to fix virtual environments.
</Callout>
