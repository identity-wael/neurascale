...
import React, { useState, type FC, type ReactNode, type Dispatch, type SetStateAction } from 'react'
import { BrainCircuit, Cpu, ShieldCheck, Bot, Eye, Users, Scale, Brain, Dna, CloudCog } from 'lucide-react'
        ...
        <nav className="hidden md:flex space-x-8">
          {navLinks.map(link => (
            <button
              ...
              className={`text-lg font-medium transition-colors duration-300 ${currentPage === link.id ? 'text-cyan-400' : 'text-gray-300 hover:text-cyan-400'}`}
            >
              {link.title}
            </button>
          ))}
          ...
          <nav className="flex flex-col items-center px-4 pt-2 pb-4 space-y-2">
            {navLinks.map(link => (
              <button
                ...
                className={`w-full text-center py-2 rounded-md text-lg font-medium transition-colors duration-300 ${currentPage === link.id ? 'bg-cyan-500 text-white' : 'text-gray-300 hover:bg-gray-700'}`}
              >
                {link.title}
              </button>
            ))}
...
const HomePage: FC<PageProps> = ({ setCurrentPage }) => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center text-center bg-cover bg-center" style={{ backgroundImage: "url('https://placehold.co/1920x1080/0a0a0a/ffffff?text=Neural+Network')" }}>
        <div className="absolute inset-0 bg-black opacity-60"></div>
        <div className="relative z-10 px-4">
          <h2 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-4">Bridging Mind and World</h2>
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">
            Pioneering advanced neural cloud technology to revolutionize human-computer interaction, restore mobility, and unlock truly immersive virtual experiences.
          </p>
          <button onClick={() => setCurrentPage('platform')} className="bg-cyan-500 text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-cyan-600 transition-transform duration-300 transform hover:scale-105">
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold mb-4 text-white">Our Vision: The Future of Interaction</h3>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Our goal is to blur the boundaries between the human mind and the real world, enabling communication at the speed of thought. We are building the infrastructure to make this a reality.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-6">
          <h3 className="text-4xl font-bold text-center mb-12 text-white">Groundbreaking Applications</h3>
      ...
      <section className="py-20 bg-gray-900">
          <div className="container mx-auto px-6">
              <h3 className="text-4xl font-bold text-center mb-12 text-white">A Specialized Neural Cloud</h3>
              <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
                  <div className="text-center md:text-left">
                      <p className="text-lg text-gray-400 mb-6">
                          General-purpose clouds can&apos;t handle the unique demands of neural data. NeuraScale provides a purpose-built platform with tailored infrastructure for real-time signal processing, advanced machine learning, and robust security.
                      </p>
                      <button onClick={() => setCurrentPage('platform')} className="border-2 border-cyan-400 text-cyan-400 font-bold py-3 px-8 rounded-full text-lg hover:bg-cyan-400 hover:text-gray-900 transition-colors duration-300">
                          Learn More
                      </button>
                  </div>
...
const PlatformPage: FC = () => {
  return (
    <div className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        <h2 className="text-5xl font-extrabold text-center mb-4 text-white">The NeuraScale Platform</h2>
        <p className="text-xl text-center text-gray-400 max-w-4xl mx-auto mb-16">
          A specialized cloud platform purpose-built for the unique challenges of processing, curating, and analyzing large-scale neural data.
        </p>

        {/* System Components */}
        <section className="mb-20">
          <h3 className="text-4xl font-bold text-center mb-12 text-white">Core System Components</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <InfoCard title="Neural Management System" description="The central nervous system of our platform, orchestrating data flow and processing." />
            <InfoCard title="Neural Ledger" description="Ensures data integrity and provides a secure, auditable record of neural data transactions." />
            <InfoCard title="Extended Reality Engine" description="Powers immersive VR/XR experiences, rendering virtual worlds from neural intent." />
            <InfoCard title="Neural Applications" description="The suite of tools and services that translate neural signals into real-world action." />
          </div>
        </section>

        {/* Layered Architecture */}
        <section className="mb-20">
          <h3 className="text-4xl font-bold text-center mb-12 text-white">A Full-Stack Architecture</h3>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-gray-800 p-8 rounded-lg">
              ...
              <p className="text-gray-400 mb-6">
                We leverage a suite of AWS services for robust, scalable, and secure edge and cloud computing, ensuring real-time data processing and device management at scale.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center"><CloudCog className="h-5 w-5 mr-3 text-cyan-400" /> AWS IoT GreenGrass & Core</li>
                <li className="flex items-center"><CloudCog className="h-5 w-5 mr-3 text-cyan-400" /> AWS IoT Device Management</li>
                <li className="flex items-center"><CloudCog className="h-5 w-5 mr-3 text-cyan-400" /> AWS IoT RoboRunner & FleetWise</li>
              </ul>
            </div>
            <div className="bg-gray-800 p-8 rounded-lg">
              <h4 className="text-3xl font-bold mb-4 text-white">Powered by Nvidia</h4>
              <p className="text-gray-400 mb-6">
                Nvidia&apos;s advanced AI and XR platforms provide the computational horsepower for our most demanding tasks, from AI model training to real-time virtual world rendering.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center"><Cpu className="h-5 w-5 mr-3 text-cyan-400" /> Nvidia OmniVerse & XR</li>
                <li className="flex items-center"><Cpu className="h-5 w-5 mr-3 text-cyan-400" /> Nvidia Holoscan & DGX Cloud</li>
                <li className="flex items-center"><Cpu className="h-5 w-5 mr-3 text-cyan-400" /> Nvidia AI Enterprise Stack</li>
              </ul>
            </div>
          </div>
        </section>
  ...
  return (
    <div className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        <p className="text-xl text-center text-gray-400 max-w-4xl mx-auto mb-16">
          Our Neural Platform as a Service is the foundation for three ambitious R&D projects, each targeting a distinct frontier in neurotechnology.
        </p>
...
const TechnologyPage: FC = () => {
  return (
    <div className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        <h2 className="text-5xl font-extrabold text-center mb-4 text-white">Intelligence at the Core</h2>
        <p className="text-xl text-center text-gray-400 max-w-4xl mx-auto mb-16">
          Our platform integrates machine learning across four distinct phases to turn complex neural data into actionable intelligence.
        </p>
...
const EthicsPage: FC = () => {
  return (
    <div className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        <h2 className="text-5xl font-extrabold text-center mb-4 text-white">Safeguarding the Future</h2>
        <p className="text-xl text-center text-gray-400 max-w-4xl mx-auto mb-16">
          Neural data is incredibly sensitive. We recognize that ensuring its protection and ethical use is paramount to our mission and the future of neurotechnology.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-800 p-10 rounded-lg shadow-lg">
                ...
                <p className="text-gray-300 text-lg">
                    We are harnessing the power of neural data for the betterment of society. This requires navigating the complexities of a rapidly evolving field with a proactive and ethical stance. By embedding privacy and security into our design from the ground up, we build trust and position ourselves as a responsible leader in neurotechnology.
                </p>
            </div>
        </div>
      </div>
    ...
    return (
        <div className="py-20 bg-gray-900">
            <div className="container mx-auto px-6">
                ...
                <p className="text-xl text-center text-gray-400 max-w-4xl mx-auto mb-16">
                    We are a deep tech venture committed to architecting the future of human-machine interaction through sustained investment and meticulous planning.
                </p>
                ...
                <section className="mb-20 text-center">
                    ...
                    <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                        To seamlessly integrate the human mind with physical and virtual realms, unlocking unprecedented possibilities in mobility, automation, and immersive experiences, all while upholding the highest standards of data integrity and ethical practice.
                    </p>
                </section>

                {/* R&D Investment Section */}
                <section className="mb-20">
                    <h3 className="text-4xl font-bold text-center mb-12 text-white">Roadmap to Reality: R&D Investment</h3>
                    <div className="bg-gray-800 rounded-lg p-8 shadow-lg max-w-4xl mx-auto">
                        ...
                        <p className="text-center text-gray-500 mt-8">
                            This sustained, multi-year investment demonstrates our serious commitment to deep technology and the long-term execution of our ambitious vision.
                        </p>
                    </div>
                </section>
                ...
                <section className="text-center">
                    ...
                    <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                        Our journey is just beginning. Future research will focus on real-world datasets, exploring the limitations of machine learning, and developing even more sophisticated models to tackle the complexities of neural data. We are building a platform not just for today, but for the future of neuroscience and AI.
                    </p>
                </section>
            </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul>
              <li className="mb-2"><button onClick={() => setCurrentPage('platform')} className="hover:text-cyan-400 transition-colors">Platform</button></li>
              <li className="mb-2"><button onClick={() => setCurrentPage('applications')} className="hover:text-cyan-400 transition-colors">Applications</button></li>
              <li className="mb-2"><button onClick={() => setCurrentPage('ethics')} className="hover:text-cyan-400 transition-colors">Ethics & Security</button></li>
              <li className="mb-2"><button onClick={() => setCurrentPage('about')} className="hover:text-cyan-400 transition-colors">About Us</button></li>
            </ul>
          </div>
          <div>
...
const FeatureCard: FC<FeatureCardProps> = ({ icon, title, description, onClick }) => (
  <div className="bg-gray-900 p-8 rounded-lg shadow-lg text-center transform hover:-translate-y-2 transition-transform duration-300 cursor-pointer" onClick={onClick}>
...
const ProjectCard: FC<ProjectCardProps> = ({ title, description, timeline, milestone, icon, reverse = false }) => (
    <div className={`flex flex-col md:flex-row items-center gap-12 ${reverse ? 'md:flex-row-reverse' : ''}`}>
        <div className="md:w-1/2 text-center md:text-left">
            <div className={`inline-block p-6 bg-gray-800 rounded-full mb-6 ${reverse ? 'md:ml-auto' : 'md:mr-auto'}`}>{icon}</div>
        ...
        <div className="md:w-1/2">
             <img src={`https://placehold.co/600x400/1f2937/38bdf8?text=${title.split(':')[0]}`} alt={title} className="rounded-lg shadow-2xl w-full h-auto" />
        </div>
    </div>
)
