...
class MCPErrorHandler:
    ...
    def create_error_response(self, error_type: str, message: str, 
        ...
        """
        error_code = self.error_codes.get(error_type, -32603)  # Default to internal_error
        ...
        # Log the error
        self.logger.error(f"MCP Error [{error_type}]: {message}", extra={
    ...
    def handle_exception(self, exception: Exception, 
        ...
        self.logger.exception(f"Unhandled exception in MCP server: {exception}", extra={
    ...
    def create_validation_error(self, field: str, message: str, 
    ...
    def create_permission_error(self, permission: str, resource: Optional[str] = None,
                              request_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    def create_rate_limit_error(self, limit_type: str, reset_time: Optional[str] = None,
                              request_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    def create_tool_error(self, tool_name: str, error_message: str,
                         request_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    def create_resource_error(self, resource_uri: str, error_message: str,
                            request_id: Optional[str] = None) -> Dict[str, Any]:
