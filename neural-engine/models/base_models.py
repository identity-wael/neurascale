            ...
            if X_val is not None:
                ...
                if self.config.get("early_stopping", True):
                    if val_loss < best_val_loss:
                        ...
                        patience_counter += 1
                        if patience_counter >= self.config.get(
...
class EEGNet(TensorFlowBaseModel):
    ...
    def __init__(
        self, n_channels: int, n_samples: int, n_classes: int, **kwargs: Any
    ) -> None:
        super().__init__(
            model_name="EEGNet",
    ...
    def build_model(self) -> keras.Model:
        ...
        # Block 2
        block2 = layers.SeparableConv2D(F2, (1, 16), use_bias=False, padding="same")(
            block1
        )
...
class CNNLSTMModel(TensorFlowBaseModel):
    ...
    def __init__(
        self, n_channels: int, n_timesteps: int, n_classes: int, **kwargs: Any
    ) -> None:
        super().__init__(
            model_name="CNN - LSTM",
    ...
    def build_model(self) -> keras.Model:
        ...
        x = layers.TimeDistributed(
            layers.Conv1D(cnn_filters // 2, 3, activation="relu")
        )(x)
...
class TransformerModel(PyTorchBaseModel):
    ...
    def __init__(
        self, n_channels: int, sequence_length: int, n_classes: int, **kwargs: Any
    ) -> None:
        super().__init__(
