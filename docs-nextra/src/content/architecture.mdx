...
graph TB
    ...
    subgraph "Frontend - Vercel"
        subgraph "NeuraScale Console"
            NC1[Next.js App<br/>React • TypeScript]
            NC2[UI Components<br/>Tailwind • shadcn/ui]
            NC3[State Management<br/>Zustand • React Query]
            NC4[Real-time Updates<br/>Socket.io Client]
        end
        V1[Vercel Edge Network<br/>Global CDN • Edge Functions]
    end

    subgraph "Authentication - Firebase"
        FB1[Firebase Auth<br/>OAuth Providers]
        FB2[User Management<br/>Profiles • Permissions]
        FB3[Session Tokens<br/>JWT • Refresh Tokens]
    end

    subgraph "User Data - NeonDB"
        subgraph "PostgreSQL Database"
            ND1[User Profiles<br/>Settings • Preferences]
            ND2[Session Metadata<br/>Experiments • Results]
            ND3[Device Configs<br/>Saved Configurations]
            ND4[Analysis History<br/>Reports • Exports]
        end
        NP1[Neon Proxy<br/>Connection Pooling]
        NP2[Neon Autoscaling<br/>Compute • Storage]
    end

    subgraph "API Gateway"
        AG1[REST API<br/>Express • Node.js]
