...
class NeuralDataMCPServer(BaseNeuralMCPServer):
                ...
                "properties": {
                    ...
                    "frequency_bands": {
                        ...
                        "properties": {
                            ...
                            "theta": {"type": "array", "items": {"type": "number"}, "minItems": 2, "maxItems": 2},
                            "alpha": {"type": "array", "items": {"type": "number"}, "minItems": 2, "maxItems": 2},
                            "beta": {"type": "array", "items": {"type": "number"}, "minItems": 2, "maxItems": 2},
                            "gamma": {"type": "array", "items": {"type": "number"}, "minItems": 2, "maxItems": 2}
                        },
            ...
            input_schema={
                ...
                "properties": {
                    ...
                    "artifact_types": {
                        ...
                        "items": {
                            "type": "string",
                            "enum": ["eye_blink", "muscle", "line_noise", "electrode_pop", "movement"]
                        },
        ...
        self.register_tool(
            ...
            input_schema={
                ...
                "properties": {
                    ...
                    "plot_type": {
                        "type": "string",
                        "enum": ["timeseries", "spectrogram", "psd", "topomap", "connectivity"],
    ...
    async def _query_sessions(self, patient_id: Optional[str] = None,
    ...
    async def _get_neural_data(self, session_id: str,
    ...
    async def _apply_filter(self, session_id: str, filter_type: str,
    ...
    async def _run_spectral_analysis(self, session_id: str,
                                   channels: Optional[List[int]] = None,
                                   method: str = "welch",
    ...
    async def _detect_artifacts(self, session_id: str,
    ...
    async def _export_neural_data(self, session_id: str, format: str,
                                channels: Optional[List[int]] = None,
                                start_time: Optional[float] = None,
                                end_time: Optional[float] = None,
    ...
    async def _create_visualization(self, session_id: str, plot_type: str,
                                  channels: Optional[List[int]] = None,
