...
const DSMPeriodicTable = dynamic(() => import('@/components/visuals/DSMPeriodicTable'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-96 bg-black/50 flex items-center justify-center text-white/60">
      Loading DSM Periodic Table...
    </div>
  ),
});

// Dynamic import for DSM Matrix to avoid SSR issues
const DSMMatrix = dynamic(() => import('@/components/visuals/DSMMatrix'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-96 bg-black/50 flex items-center justify-center text-white/60">
      Loading DSM Matrix...
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-white/70 max-w-3xl">
              ...
              and dependency matrix. Each element represents a core component of the NEURASCALE
              platform, from neural interfaces to cloud infrastructure and AI frameworks.
            </p>
          </div>
