...
<Callout type="info">
  The project is already configured with Sanity project ID `vvsy01fb`. To set up your own project, follow the steps below.
</Callout>
...
<Callout type="tip">
  Use preview mode to see unpublished content in your development environment.
</Callout>
