...
class MCPRateLimiter:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.default_limits = config.get("default", {
    ...
    async def check_limit(self, client_id: str, method: str = None, 
        ...
        for limit_type, limit_config in limits.items():
            if not await self._check_specific_limit(limit_key, limit_type, limit_config):
                return False
    ...
    async def get_rate_limit_status(self, client_id: str, method: str = None, 
        ...
        for limit_type, limit_config in limits.items():
            remaining, reset_time = self._get_limit_status(limit_key, limit_type, limit_config)
    ...
    async def reset_limits(self, client_id: str, method: str = None, 
                          user_id: str = None) -> bool:
    ...
    def _get_limit_key(self, client_id: str, method: str = None, 
    ...
    def _get_applicable_limits(self, method: str = None, 
    ...
    async def _check_specific_limit(self, limit_key: str, limit_type: str, 
                                  limit_config: Dict[str, Any]) -> bool:
    ...
    def _check_time_window_limit(self, limit_key: str, limit_type: str, 
                               limit_config: Dict[str, Any]) -> bool:
    ...
    def _check_burst_limit(self, limit_key: str, limit_type: str, 
                          limit_config: Dict[str, Any]) -> bool:
    ...
    def _get_limit_status(self, limit_key: str, limit_type: str, 
                         limit_config: Dict[str, Any]) -> tuple:
        ...
        if limit_type.endswith("burst_limit"):
            ...
            valid_requests = sum(1 for req_time in request_times if req_time >= window_start)
