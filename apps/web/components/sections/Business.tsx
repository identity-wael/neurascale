...
const CloudIcon = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M12 24 C8 24, 6 20, 8 16 C10 12, 14 12, 16 14 C18 10, 22 10, 26 12 C30 14, 32 18, 30 22 C32 24, 32 28, 28 28 L12 28"
      stroke="currentColor"
      strokeWidth="1"
      fill="none"
      opacity="0.8"
  ...
  const businessModel = [
    {
      ...
      description:
        'Complete SaaS platform with real-time neural processing, AI model hosting, and 24/7 support for healthcare providers and research institutions.',
      icon: <CloudIcon />,
    ...
    },
    {
      ...
      description:
        'Custom installations for organizations requiring local data processing, enhanced security, and specialized integration with existing systems.',
      icon: <EnterpriseIcon />,
    ...
    },
    {
      ...
      description:
        'Large-scale implementations for veteran affairs, defense applications, and public healthcare systems with specialized compliance requirements.',
      icon: <GovernmentIcon />,
  ...
  const revenueStreams = [
    {
      ...
      description:
        'Monthly/annual SaaS subscriptions based on data processing volume and feature access',
      percentage: '60%',
    },
    {
  ...
  return (
    <section ref={containerRef} className="min-h-screen px-6 md:px-12 lg:px-24 py-24 relative">
      <motion.div style={{ scale }} className="relative z-10">
        ...
        >
          NEURASCALE follows a proven commercial model similar to Kubernetes, combining open-source
          innovation with sustainable revenue streams to accelerate neural interface adoption
          globally.
        </motion.p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {businessModel.map((model, index) => (
              ...
              >
                ...
                <p className="text-white/70 text-sm mb-6 leading-relaxed">{model.description}</p>
